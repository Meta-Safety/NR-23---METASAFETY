...
public class Class_K : MonoBehaviour
{
    ...
    private void OnParticleCollision(GameObject other)
    {
        ...
        if (other.CompareTag("classA") || other.CompareTag("classB") || other.CompareTag("classC") || other.CompareTag("classD"))
        {
