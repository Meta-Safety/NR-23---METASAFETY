...
public class Class_D : MonoBehaviour
{
    ...
    private void OnParticleCollision(GameObject other)
    {
        ...
        if (other.CompareTag("classA") || other.CompareTag("classB") || other.CompareTag("classC") || other.CompareTag("classK"))
        {
