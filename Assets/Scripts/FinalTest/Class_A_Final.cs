...
public class Class_A_Final : MonoBehaviour
{
    private const string FINAL_WRONG_EXTINGUISHER_COUNT_KEY = "WrongExtinguisherCount";
    ...
    private void Awake()
    {
        ...
        // extinguisherController = FindFirstObjectByType<ExtinguisherController>();
    ...
    private void OnParticleCollision(GameObject other)
    {
        ...
        if (other.CompareTag("classA"))
        {
            other.GetComponent<ObjectFireController>().AddFireCountered();
        ...
        if (other.CompareTag("classB") || other.CompareTag("classC"))
            ...
            {
                canAlert = false;
                respawnManager.WrongExtinguisher();
    ...
    public void RegisterWrongExtinguisherUse()
    {
        ...
        {
            int currentCount = PlayerPrefs.GetInt(FINAL_WRONG_EXTINGUISHER_COUNT_KEY, 0);
            PlayerPrefs.SetInt(FINAL_WRONG_EXTINGUISHER_COUNT_KEY, currentCount + 1);
            PlayerPrefs.Save();
